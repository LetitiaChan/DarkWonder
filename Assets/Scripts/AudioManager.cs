...
* 
*    Modify Recoder: 
*          1> 2016.00.00   刘国柱    First Submission
*          2> 2017.03.07   L.T.      使用属性代替set方法
* 
*/
using UnityEngine;
...
public class AudioManager : MonoBehaviour
{
    ...
    private static float _AudioBackgroundVolumns = 1F;                         //背景音量
    private static float _AudioEffectVolumns = 1F;                             //音效音量
